...
return [
    ...
    'quote_filters' => [
        'group' => 'Admin — Quotes Filters',
        'label' => 'Quote filter cards (order = priority)',
        'type' => 'list',
        'default' => ['new', 'reviewing_quoted', 'finalize_scheduling', 'scheduled', 'service_performed', 'equipment_delivered', 'left_voicemail', 'completed30'],
    ],
